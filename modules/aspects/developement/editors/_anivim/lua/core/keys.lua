...
local keymaps = {
    ...
    {keys.right, 'l', opts = {noremap = true}}, 
    -- map existing keys to hjkl
    {'h', keys.left, opts = {noremap = true}},
    {'j', keys.down, opts = {noremap = true}},
    {'k', keys.up, opts = {noremap = true}},
    {'l', keys.right, opts = {noremap = true}}, 
    -- Splits
